...
def generate_knowledge_medical_answer(
    ...
    prompt = (
        ...
        f"2. DIRECT & DEFINITIVE ANSWER: Answer the patient's inquiry clearly and authoritatively in the opening paragraph.\n"
        f"3. CLEAR CLINICAL STRUCTURE:\n"
        f"   - 🌿 **What is Happening in the Body**: Explain the physiological mechanisms and what the body is experiencing in 2-3 comforting, crystal-clear sentences.\n"
        f"   - 🍃 **Doctor's Herbal Prescription & Botanical Remedies**: Prescribe 3-4 top proven WHO/Pharmacopeia medicinal plants (e.g. Sweet Annie / Artemisia annua, Ghanaian Quinine / Cryptolepis sanguinolenta, Bitter Leaf / Vernonia amygdalina, Neem / Azadirachta indica, Moringa, Turmeric, Ginger) with their active bioactives and therapeutic actions.\n"
        f"   - 🍵 **Step-by-Step Preparation & Exact Dosing Schedule**: Provide clear kitchen preparation instructions (water volume in Liters, boiling/steeping minutes) and exact teacup dosages (e.g. 1 teacup [150 mL] warm, 2-3 times daily after meals for 5–7 days).\n"
        f"   - 💡 **Simple Home Care & Dietary Support**: Practical recovery foods, hydration, and resting tips that accelerate natural healing. Mention that they can use the **Cook Mode HUD** in the **Patient Care Toolkit** to set an exact 20-minute pot simmer countdown timer, or the **Organ Hologram** to visualize the targeted organ system.\n"
        f"   - ⚠️ **Emergency Red Flags**: A brief safety reminder for extreme emergency complications (e.g. convulsions, persistent vomiting, loss of consciousness), NOT as a deflection from your herbal prescription.\n"
        f"4. COMPLETE THOUGHTS: Complete every paragraph and sentence fully. Never leave sentences unfinished.\n"
        f"5. WARM NEXT STEP: Conclude with an open, caring question offering to fine-tune their daily schedule or answer questions.\n\n"
